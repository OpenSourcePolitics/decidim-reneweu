  ...
  describe "Sign Up" do
    ...
    context "when using another langage" do
      ...
      it "keeps the locale settings" do
        ...
        expect(page).to have_content("Te hemos enviado un enlace de confirmación a tu dirección de correo electrónico. Haz clic en dicho enlace para activar la cuenta.")
